...
if __name__ == '__main__':
    ...
    # print(latlon2xy(-44.2, 171.0))        # ymax = 313
    # print(latlon2xy(-40.48, 176.2))          # ymin = -291
    # print(latlon2xy(-44.2, 176.2))          # xmax = 400
    # print(latlon2xy(-40.48, 171.0))        # xmin = -300
    ...
    pickle.dump(vp3d, open(savedir + 'vp3d.p', 'wb'))
    ...
    for i,j,k in zip(stnms, stlas, stlos):
        ...
        pickle.dump(ttsave, open(savedir + 'ttp_' + stnm + '.p', 'wb'))
