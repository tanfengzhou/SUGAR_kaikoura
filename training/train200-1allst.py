...
savedir = 'syn_wave/toAI/data1970/02/03clean/'
...
for i in range(nsta):
    ...
    n[0].data = wf[i][1]
    e[0].data = wf[i][2]
    z[0].stats.starttime = '1970-02-03T00:00:00.0Z'
    n[0].stats.starttime = '1970-02-03T00:00:00.0Z'
    e[0].stats.starttime = '1970-02-03T00:00:00.0Z'
