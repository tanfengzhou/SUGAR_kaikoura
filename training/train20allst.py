...
savedir = 'syn_wave/toAI/data1970/02/06clean/'

wf = np.zeros([nsta, 3, (20*60+5)*60*sr])

#ot = np.random.random(400) * 3600 * 20
...
for i in range(nsta):
    ...
    n[0].data = wf[i][1]
    e[0].data = wf[i][2]
    z[0].stats.starttime = '1970-02-06T00:00:00.0Z'
    n[0].stats.starttime = '1970-02-06T00:00:00.0Z'
    e[0].stats.starttime = '1970-02-06T00:00:00.0Z'
