...
savedir = 'syn_wave/toAI/data1970/02/02clean/'

wf = np.zeros([nsta, 3, (21*60+5)*60*sr])

#ot = np.random.random(7000) * 3600 * 21
...
for i in range(nsta):
    ...
    n[0].data = wf[i][1]
    e[0].data = wf[i][2]
    z[0].stats.starttime = '1970-02-02T00:00:00.0Z'
    n[0].stats.starttime = '1970-02-02T00:00:00.0Z'
    e[0].stats.starttime = '1970-02-02T00:00:00.0Z'
